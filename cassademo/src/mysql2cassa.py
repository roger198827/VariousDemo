...
class MysqlImport():
    def __init__(self):
        self.conn = MySQLdb.connect(host="localhost",user="root",passwd="root",db="contentdb",charset="utf8")
        self.pool = ConnectionPool(keyspace='contentsp', server_list=['10.107.4.187:9160'], prefill=False)
    ...
    def getPageCount(table_name, perpage):
